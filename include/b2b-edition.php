<section class="choose-us style-9 edition_section_b2b d-none" id="b2b_edition_section">
    ...
    <div class="info">
        <div class="section-head style-3 mb-30 mt-30">
            <h3 style="font-size: 25px;"> B2B <span> Editions </span></h3>
        </div>
...
<section class="about style-7" style="padding:0 2%">
    <div class="container">
...
<div class="col-lg-12 mt-20" style="padding:0 37px">
    <div class="info">
        ...
        <div class="section-head style-3 mb-30 mt-30">
            <h3 style="font-size: 25px;"> B2B Bundles for <span> MSP and CSP </span></h3>
        </div>
