<section class="about-app style-5">
                                            <div class="container"
                                                ...
                                                <div class="content text-left">
                                                    <h1 class="color-000 mb-20">ITSM Integration </h1>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-sm-12 info">
                                                                <div class="about-card mb-30 mb-lg-0  lh-4">
                                                                    ...
                                                                    <p class="mb-2 mt-2">
                                                                    Trace9 4.0 is a flexible monitoring solution that seamlessly integrates into your existing infrastructure. You can stick to your preferred tool landscape, as it allows for seamless communication between the Trace9 4.0 monitoring solution and your ITSM platform. Whenever an issue is detected by Trace9 4.0, it will automatically create an incident ticket in the ITSM platform, assign it to the appropriate team or individual, and track its progress until it is resolved. 
                                                                    </p>
                                                                    <p class="mb-2">
                                                                        <ul>
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000">  Use existing data to feed Trace9 with configurations </strong>   </div>    
                                                                            </li>
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000"> Automate your workflows and integrate with existing processes  </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000">  The Trace9 4.0 monitoring solution selects the best option to maintain monitoring configurations   </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000"> Track all changes and roll back at any time   </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000">  Connect with Jira and other issue tracking and ticketing systems  </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000"> Leverage existing data.   </strong>  </div>    
                                                                            </li> 
                                                                        </ul>  
                                                                    </p>
                                                                    <p class="mb-2">
                                                                        Monitoring every piece of infrastructure requires a lot of perseverance and discipline. Trace9 4.0 monitoring solution reduces the error rate due to missing information by connecting to existing databases and fetching available information, whether it is a CMDB, private cloud, public cloud, or a custom-built internal tool that holds the information about your physical and virtual servers.
                                                                    </p>
                                                                    <p class="mb-2">
                                                                        Trace9 4.0 collects the data automatically and converts it to a valid monitoring configuration with many options to transform the information and create an optimal workflow that fits your organization. 
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="about-card mb-30 mb-lg-0  lh-4">
                                                                    ...
                                                                    <p class=" mt-2">
                                                                        <ul>
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000">  Import your server information, such as name, IP address, device ID, and others.  </strong>   </div>    
                                                                            </li>
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000"> Synchronize your contacts for alerts with Active Directory or LDAP.   </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000">  Automatically monitor your services based on collected server metadata.   </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000"> Integrate with automated workflows for data import, synchronization, and configuration deployment.    </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000">  Track every single change and roll back at any time.  </strong>  </div>    
                                                                            </li>  
                                                                        </ul>  
                                                                    </p> 
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-sm-12 info">
                                                                <div class="about-card mb-30 mb-lg-0  lh-4">
                                                                    ...
                                                                    <p class="mt-10">
                                                                    External platforms provide value to your operations team by handling specific daily tasks. Whether it’s incident management, data collection, correlation of data or asset management. Trace9 4.0 solution connects to many different platforms and embeds the monitoring process in your daily workflows. 
                                                                    </p>
                                                                    ...
                                                                    <p class="mt-10">   
                                                                        <ul>
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000">  Connect Trace9 4.0 with incident management tools such as PagerDuty, OpsGenie, VictorOps and more   </strong>   </div>    
                                                                            </li>
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000"> Synchronize Trace9 4.0 monitoring data with ServiceNow   </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000">  Attach Trace9 4.0 to public cloud providers, such as AWS, Azure or GCP .   </strong>  </div>    
                                                                            </li> 
                                                                            <li class="d-flex mb-20"> 
                                                                                <i class="fas fa-check-circle color-blue7 me-2 mt-2"></i>
                                                                                <div class="text"> <strong class="color-000"> Create custom integrations by using Trace9’s open APIs    </strong>  </div>    
                                                                            </li> 
                                                                    ...
                                                                    <p class="mt-10">  
                                                                        ...
                                                                        <br/>
                                                                        There are a variety of technologies, protocols, and devices that can be used to support ITSM integration in Trace9 4.0 monitoring solution. Here are a few: 
                                                                    </p>
                                                                    <p class="mt-10">  
                                                                        <strong class="color-000"> 
                                                                        APIs
                                                                        ...
                                                                        <br/>
                                                                        Trace9 4.0 monitoring solution offers APIs that can be used to integrate with ITSM platforms which allow APIs data to be shared between different systems, enabling automated processes and real-time updates.. 
                                                                    </p>
                                                                    <p class="mt-10">  
                                                                        <strong class="color-000"> 
                                                                        Webhooks
                                                                    ...
                                                                    <p class="mt-10">  
                                                                        ...
                                                                        <br/>
                                                                        Trace9 4.0 monitoring solution use agents, which are software programs that are installed on servers, network devices, or other endpoints. Agents collect data from the endpoints and send it to the Trace9 4.0 monitoring solution, which can then integrate with the ITSM platform. 
                                                                        <br/>
                                                                        Conclusion, the specific technologies, protocols, and devices used for ITSM integration in Trace9 4.0 monitoring solution will depend on the specific tools and platforms being used. 
                                                                    </p>
                                                                    <p class="mt-10">  
                                                                        <strong class="color-000"> 
                                                                        Module Dependency??? 
                                                                    ...
                                                                    <p class="mt-10">  
                                                                        ...
                                                                        <br/>
                                                                        This module allows the Trace9 4.0 monitoring solution to send notifications and alerts to the ITSM platform. Notifications may include alerts, warnings, or other messages related to issues detected by the Trace9 4.0 monitoring solution. 
                                                                    </p>
                                                                    ...
                                                                    <p class="mt-10">  
                                                                        ...
                                                                        <br/>
                                                                        Conclusion, the specific module dependencies will depend on the functionality and features required for ITSM integration in the Trace9 4.0 monitoring solution.  
                                                                    </p>
                                                                ...
                                                                <div class="about-card mb-30 mb-lg-0  lh-4">
                                                                    ...
                                                                    <section class="about   style-4">
                                                                        <div class="content frs-content" style="padding:0">
                                                                            ...
                                                                            <img src="assets/img/about/about_s4_lines.png"
                                                                                alt="" class="lines">
                                                                            <img src="assets/img/about/about_s4_bubble.png"
                                                                                alt="" class="bubble">
                                                                        </div>
                                                                    </section>
