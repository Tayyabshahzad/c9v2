            ...
            <div class="section-head style-3  align-items-center" style="margin-top:90px;">
                <div class="info">
                    <div class="section-head style-4 mb-20">
                        <h2 class=""> <span> Rootkit   </span> Detection</h2>
                    </div>
                </div>
                <p class="mt-4">
                ...
                <div class="imgs-items border-1 border-bottom border-top brd-gray">
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Early Detection of Rootkits </h5>
                                <p>Amygdala XDR's rootkit detection module detects rootkits early before they have a chance to cause serious damage to a system or network. This can help organizations respond quickly and minimize the impact of an attack.  
                                     </p>
                            </div>
                        </div>
                    </div>
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Multi-platform Support </h5>
                                <p>Amygdala XDR's rootkit detection module supports a wide range of operating systems, including Windows, Linux, macOS, and others. This makes it a flexible and versatile solution for organizations with diverse IT environments.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p>Amygdala XDR's rootkit detection module includes file integrity monitoring, which can detect changes to critical system files that may be indicative of a rootkit. This can help organizations identify suspicious activity and take action to investigate and remediate potential threats.  
                ...
                <div class="imgs-items border-1 border-bottom border-top brd-gray">
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> System calls and kernel modules </h5>
                                <p>Amygdala XDR's rootkit detection f module uses a range of system calls and kernel modules to monitor system activity and detect signs of a rootkit. These low-level tools provide a granular view of system behavior, enabling the module to identify even subtle indications of a rootkit.   </p>
                            </div>
                        </div>
                    </div>
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Open-Source Security Information Management (OSSIM) </h5>
                                <p>Amygdala XDR's rootkit detection module is built on the OSSIM framework, which provides a scalable, centralized platform for managing security information. OSSIM enables the module to collect and correlate data from multiple sources, enhancing its ability to detect rootkits.  <br/>
                                File Integrity Checking (FIM) tools: Amygdala XDR's rootkit detection module uses FIM tools to monitor changes to critical system files and directories. By comparing the current state of a file to a known baseline, the module can detect if a file has been modified or replaced by a rootkit. 
                                <br/>
