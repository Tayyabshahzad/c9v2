            ...
            <div class="section-head style-3  align-items-center" style="margin-top:90px;">
                <div class="info">
                    <div class="section-head style-4 mb-20">
                        ...
                        <h2 class="">   <span> Container   </span>  Security  </h2>
                    </div>
                </div>
                <p class="mt-4">
                ...
                <div class="imgs-items border-1 border-bottom border-top brd-gray">
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Continuous Monitoring  </h5>
                                <p>It provides continuous monitoring of container images, host, and orchestration platforms to detect vulnerabilities and configuration issues.   </p>
                            </div>
                        </div>
                    </div>
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Security Assessment </h5>
                                <p> It performs automatic security assessments of Docker containers and Kubernetes environments.    </p>
                            </div>
                        </div>
                    </div>
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Risk Management </h5>
                                <p> It provides a risk score for containers and clusters based on the severity of vulnerabilities, misconfigurations, and other security issues. 
                    ...
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p>It can help you achieve compliance with industry security standards by detecting security issues and misconfigurations. 
                    ...
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            <div class="col-lg-2">
                                <div class="icon mb-3 mb-lg-0">
                                    <img src="assets/img/product/005-data-integration.png" alt="">
                                </div>
                            </div>
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Integration </h5>
                                <p> It integrates with popular container platforms like Docker and Kubernetes, and also with orchestration platforms like Docker Swarm and OpenShift  
        ...
        <div class="row gx-0 justify-content-between">
            ...
            <div class="col-lg-12">
                ...
                <p class="pb-50 mt-20 mb-20 text-center">
                        <img src="assets/img/dashboards/amygdala/container-security.png" class="img-thumbnail"  alt="">
                </p> 
            </div>
        </div>
    </div>
