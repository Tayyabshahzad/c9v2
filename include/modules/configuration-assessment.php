<section class="style-3" style="background-image: url('assets/img/integ_11_pattern.png');">
    <div class="container" style="margin-top:-3%">
            ...
            <div class="section-head style-3  align-items-center" style="margin-top:90px;">
                <div class="info">
                    <div class="section-head style-4 mb-20">
                        ...
                        <h2 class="">   <span> Configuration </span> Assessment </h2>
                    </div>
                </div>
                <p class="mt-4">
        ...
        <div class="col-lg-12 mt-30">
            <div class="main-info">
            <h3 class="text-capitalize mb-20">Benefits & Modules </h3>
                <div class="imgs-items border-1 border-bottom border-top brd-gray">
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Automated configuration assessment </h5>
                                <p> Amygdala XDR's configuration assessment module enables organizations to automate the process of assessing the configuration of their systems and applications. This reduces the manual effort required to ensure compliance with security policies and best practices and provides real-time alerts when configuration changes violate policies.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p> Amygdala XDR's configuration assessment module allows organizations to define their policies or use pre-defined templates to assess configurations. This enables organizations to tailor the assessments to their specific security policies and compliance requirements.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p>The module provides real-time alerts and notifications when a configuration change violates a policy. This allows organizations to respond quickly to potential security incidents and take action to prevent harm. 
                    ...
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2">   Comprehensive reports </h5>
                                <p>Amygdala XDR's configuration assessment module provides detailed reports on configuration assessments, making it easy to demonstrate compliance with internal and external policies and standards. 
                    ...
                    <div class="img-item my-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10">
                                <h5 class="fw-bold mb-2"> Integration with other security tools </h5>
                                <p>Amygdala XDR's configuration assessment module can be integrated with other security tools, such as intrusion detection systems, to provide a more comprehensive view of security threats. 
